			...
			<div className="bg-white text-slate-900 px-[6%] mx-[3%] py-12 rounded-lg grid place-content-center z-30 shadow-card relative">
				<div className="text-center grid gap-8">
					<div className="grid gap-3">
						...
						<p>
							Subscribe to our ultra-exclusive drop list and be
							the first to know about upcoming drops.
						</p>
					</div>

					<form
						className="flex flex-nowrap lg:w-4/5 lg:mx-auto"
						method="POST"
					>
						<label
							className="rounded-l-lg py-0.5 pl-3 pr-1 bg-white text-slate-900 flex items-center w-full border border-slate-200 focus-within:border-brand-dark-rose/[0.2]"
					...
					<small
						className="-mt-5 mx-auto block lg:w-4/5"
