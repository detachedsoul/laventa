...
const fetchData = async () => {
	...
	if (!req.ok) {
		return `There was an error fetching the requested resource. Please make sure that the API endpoint ${process.env.NEXT_PUBLIC_API_URL}products?populate=* is correct.`;
	} else {
